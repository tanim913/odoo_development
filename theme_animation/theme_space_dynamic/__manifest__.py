{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            '/theme_space_dynamic/static/src/scss/preloader.scss',
            '/theme_space_dynamic/static/src/scss/template.scss',
            '/theme_space_dynamic/static/src/scss/animation.scss',
            '/theme_space_dynamic/static/src/js/preloader.js',
            '/theme_space_dynamic/static/src/js/animation.js',
